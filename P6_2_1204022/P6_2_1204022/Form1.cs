...
namespace P6_2_1204022
{
    public partial class Form1 : Form
    {
        ...
        private DataSet CreateProdiDataSet()
        {
        ...
        {
            string url = "server=localhost;userid=root;password=;database=p6_1204022";
            string myConnectionString = "integrated security=true;datasource=localhost;initial catalog=p6_1204022";
            MySqlConnection conn = new MySqlConnection(url);
            ...
            {
                MessageBox.Show("Data tidak terupdate: " + ex.Message);
                myTrans.Rollback();
            }
